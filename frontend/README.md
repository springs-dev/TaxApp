...
```sh
$ docker build -t my-tax-appeal .   # Build docker container
$ docker run -d --name my-tax-appeal -p 4000:4000 my-tax-appeal  # Run docker container
```
App will be running at <http://localhost:4000>

```sh
$ docker stop my-tax-appeal   # Stop container
```
